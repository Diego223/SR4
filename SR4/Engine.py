...
class Renderer(object):
    ...
    def glLoadModel(self, filename, texture = None, translate = V3(0,0,0), scale = V3(1,1,1)):
        ...
        light = V3(0,0,-1)
        light = light / pn.linalg.norm(light)
        ...
        for face in model.faces:
            ...
            normal = pn.cross(pn.subtract(vert1,vert0), pn.subtract(vert2,vert0))
            normal = normal / pn.linalg.norm(normal) # la normalizamos
            intensity = pn.dot(normal, -light)
